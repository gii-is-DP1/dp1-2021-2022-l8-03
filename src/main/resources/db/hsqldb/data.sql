...
INSERT INTO piece(id, num_salmon, stuck, player_id, round_id, tile_id,color,type) VALUES (3, 2, false, 5, 4, 19,'BLACK','HORSE');
INSERT INTO piece(id, num_salmon, stuck, player_id, round_id, tile_id,color,type) VALUES (4, 2, false, 5, 4, 18,'BLACK','HORSE');
INSERT INTO piece(id, num_salmon, stuck, player_id, round_id, tile_id,color,type) VALUES (5, 2, false, 5, 4, 25,'BLACK','HORSE');
INSERT INTO piece(id, num_salmon, stuck, player_id, round_id, tile_id,color,type) VALUES (6, 2, false, 5, 4, 28,'BLACK','HORSE');
INSERT INTO piece(id, num_salmon, stuck, player_id, round_id, tile_id,color,type) VALUES (7, 2, false, 5, 4, 26,'BLACK','HORSE');
INSERT INTO piece(id, num_salmon, stuck, player_id, round_id, tile_id,color,type) VALUES (8, 2, false, 5, 4, 35,'BLACK','HORSE');
INSERT INTO piece(id, num_salmon, stuck, player_id, round_id, tile_id,color,type) VALUES (9, 2, false, 5, 4, 31,'BLACK','HORSE');